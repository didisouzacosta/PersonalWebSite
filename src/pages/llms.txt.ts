...
export function GET() {
    return new Response(
        [
            ...
            "",
            "## Apps",
            `- [DuoTake](${absoluteUrl("/apps/duotake/")}): Reaction dual cam iPhone app that records front and rear cameras together with creator layouts, Cutout background removal, and a premium Teleprompter.`,
